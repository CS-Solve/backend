...
import com.comssa.api.comment.dto.ResponseCommentDto
...
@RestController("/question/comment")
@Api(tags = ["댓글"])
class CommentController(
	...
	fun addComment(
		...
		ResponseEntity.ok(ResponseCommentDto.from(commentService.makeComment(requestMakeCommentDto, user)))
}
