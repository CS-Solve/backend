package com.core.computerscience.chatbot.service.implement

import com.core.computerscience.chatbot.config.RestTemplateService
import com.core.computerscience.chatbot.dto.request.ChatGptBatchRequestDto
import com.core.computerscience.chatbot.dto.request.ChatGptRequestFileUploadDto
import com.core.computerscience.chatbot.dto.request.ChatGptRestRequestDto
import com.core.computerscience.chatbot.dto.request.ChatMessageDto
...
class ChatGptService(
	...
	private val fileConvertService: com.core.computerscience.chatbot.service.implement.FileConvertService,
) {
		...
		val response =
			restTemplateService
				.sendPostRequest(
					...
					com.core.computerscience.chatbot.dto.response.ChatGptResponseDto::class.java,
				).body
