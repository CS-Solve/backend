package com.persistence.computerscience.question.major.domain.user.dto.request;
...
public class RequestGetQuestionByCategoryAndLevelDto {
    ...
    public static RequestGetQuestionByCategoryAndLevelDto from(List<QuestionCategory> questionCategories,
     ...
     */
    public static RequestGetQuestionByCategoryAndLevelDto fromKorean(List<String> questionCategories,
     ...
     */
    private static <T extends Enum<T>> List<T> mapOrGetAllEnumValues(List<String> values, Class<T> enumClass,
