...
class AdminMajorQuestionClassifiedServiceTest extends ServiceIntegrationTest {
    ...
    void checkMajorQuestionIsApproved(){
        ...
        List<MajorMultipleChoiceQuestion> selectedCategoryQuestion = questions.get(majorMultipleChoiceQuestion.getQuestionCategory());
    ...
    void checkMajorQuestionIsSorted(){
         ...
         */
        //then
        Assertions.assertThat(selectedCategoryQuestion).isSortedAccordingTo(Comparator.comparing(MajorMultipleChoiceQuestion::isIfApproved));
    }
