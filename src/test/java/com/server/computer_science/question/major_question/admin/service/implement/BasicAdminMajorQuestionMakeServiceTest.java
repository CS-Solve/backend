...
class BasicAdminMajorQuestionMakeServiceTest extends ServiceIntegrationTest {
    ...
    void makeMajorMultipleChoiceQuestions(){
        ...
        List<RequestMakeMultipleChoiceQuestionDto> makeMultipleChoiceQuestionDtoList =
                List.of(RequestMakeMultipleChoiceQuestionDto.from(majorMultipleChoiceQuestion,majorMultipleChoiceQuestion.getQuestionChoices()));

        //when
        List<MajorMultipleChoiceQuestion> newQuestions = basicAdminMajorQuestionMakeService.makeMultipleChoiceQuestions(makeMultipleChoiceQuestionDtoList);
    ...
    void makeMajorMultipleChoiceQuestionsDuplicateContent(){
        ...
        List<RequestMakeMultipleChoiceQuestionDto> makeMultipleChoiceQuestionDtoList =
                List.of(RequestMakeMultipleChoiceQuestionDto.from(majorMultipleChoiceQuestion,majorMultipleChoiceQuestion.getQuestionChoices()),
                        RequestMakeMultipleChoiceQuestionDto.from(majorMultipleChoiceQuestion,majorMultipleChoiceQuestion.getQuestionChoices())
                        );
        //when
        List<MajorMultipleChoiceQuestion> newQuestions = basicAdminMajorQuestionMakeService.makeMultipleChoiceQuestions(makeMultipleChoiceQuestionDtoList);
