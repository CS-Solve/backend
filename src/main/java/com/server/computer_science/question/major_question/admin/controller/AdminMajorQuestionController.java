...
public class AdminMajorQuestionController {
    ...
    public ResponseEntity<ResponseQuestionDto> toggleApproveNormalQuestion(@PathVariable("id")Long questionId) {
        return ResponseEntity.ok(ResponseMajorQuestionForAdmin.forAdmin(adminNormalQuestionUpdateService.toggleApproveNormalQuestion(questionId)));
    }
    ...
    public ResponseEntity<ResponseQuestionDto> toggleCanBeShortAnswered(@PathVariable("id")Long questionId) {
        return ResponseEntity.ok(ResponseMajorQuestionForAdmin.forAdmin(adminNormalQuestionUpdateService.toggleCanBeShortAnswered(questionId)));
    }
    ...
    public ResponseEntity<ResponseQuestionDto> changeQuestion(
        ...
        return ResponseEntity.ok(ResponseMajorQuestionForAdmin.forAdmin(adminNormalQuestionUpdateService.changeContent(questionId, requestChangeContentDto)));
    }
    ...
    public ResponseEntity<ResponseQuestionDto> changeDescription(
        ...
        return ResponseEntity.ok(ResponseMajorQuestionForAdmin.forAdmin(adminNormalQuestionUpdateService.changeDescription(questionId,requestChangeDescriptionDto)));
    }
