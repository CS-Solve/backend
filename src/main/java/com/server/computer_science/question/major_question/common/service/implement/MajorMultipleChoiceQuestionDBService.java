package com.server.computer_science.question.major_question.common.service.implement;
...
public class MajorMultipleChoiceQuestionDBService {
    ...
    // 카테고리, 레벨로 조회 - 선택지까지
    public List<MajorMultipleChoiceQuestion> getFetchChoicesByCategoriesAndLevels(List<QuestionCategory> categories, List<QuestionLevel> questionLevels){
     ...
     */
    // 카테고리, 레벨로 조회 - 선택지까지
    public List<MajorMultipleChoiceQuestion> findAllFetchChoicesByCategoriesAndLevelsApproved(List<QuestionCategory> categories, List<QuestionLevel> questionLevels){
    ...
    public List<MajorMultipleChoiceQuestion> findAllFetchChoicesByCategoriesAndLevelsApprovedAndShortAnswered(List<QuestionCategory> categories, List<QuestionLevel> questionLevels){
        return majorQuestionRepository.findFetchChoicesWithCategoriesAndLevelsAndIfApprovedAndCanBeShortAnswered(categories,questionLevels);
    }
