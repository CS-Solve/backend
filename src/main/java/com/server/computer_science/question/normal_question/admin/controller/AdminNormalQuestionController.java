...
public class AdminNormalQuestionController {
    ...
    public ResponseEntity<ResponseNormalQuestionDto> toggleApproveNormalQuestion(@PathVariable("id")Long questionId) {
        return ResponseEntity.ok(ResponseNormalQuestionDtoForAdmin.forAdmin(adminNormalQuestionUpdateService.toggleApproveNormalQuestion(questionId)));
    }
    ...
    public ResponseEntity<ResponseNormalQuestionDto> toggleCanBeShortAnswered(@PathVariable("id")Long questionId) {
        return ResponseEntity.ok(ResponseNormalQuestionDtoForAdmin.forAdmin(adminNormalQuestionUpdateService.toggleCanBeShortAnswered(questionId)));
    }
    ...
    public ResponseEntity<ResponseNormalQuestionDto> changeQuestion(
        ...
        return ResponseEntity.ok(ResponseNormalQuestionDtoForAdmin.forAdmin(adminNormalQuestionUpdateService.changeContent(questionId, requestChangeContentDto)));
    }
    ...
    public ResponseEntity<ResponseNormalQuestionDto> changeDescription(
        ...
        return ResponseEntity.ok(ResponseNormalQuestionDtoForAdmin.forAdmin(adminNormalQuestionUpdateService.changeDescription(questionId,requestChangeDescriptionDto)));
    }
    ...
    public ResponseEntity<Void> deleteNormalQuestion(@PathVariable("id")Long questionId) {
        adminNormalQuestionUpdateService.deleteQuestion(questionId);
